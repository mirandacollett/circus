        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonClass'     : 'mdl-button',       // A class to add to the UploadiFive button
                    ...
                    'fileType'        : ['application/pdf'],// Acceptable file types
                    ...
                    'uploadScript'    : 'uploader.php',     // The path to the upload script
                    ...
                    if (settings.fileType) {
                        if ($.isArray(settings.fileType)) {
                            ...
                            for (var n = 0; n < settings.fileType.length; n++) {
                                ...
                                //else {alert(file.type+" is not a valid file type ");}
                            }
                            if (!isValidFileType) {
                                alert(file.type+" is not a valid file type");
