...
<body class='hide'>
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header mdl-layout__header--waterfall">
            <div class="mdl-layout__header-row">
                ...
                <span class="mdl-layout-title mdl-layout-spacer">Manage Left Sidebar</span>
        ...
        <main class="mdl-layout__content">
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    <div class="mdl-typography--headline">Left Sidebar</div>
                </div>
                    ...
                    <div class="mdl-card__supporting-text">
                        <form id="fmLSB">
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                                <input type="radio" class="mdl-radio__button" name="lsb" value="none">
                                <span class="mdl-radio__label">No Left Sidebar</span>
                            </label><br>
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                                <input type="radio" class="mdl-radio__button" name="lsb" value="logos">
                                <span class="mdl-radio__label">Logos or Photos</span>
                            </label><br>
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                                <input type="radio" class="mdl-radio__button" name="lsb" value="fb">
                                <span class="mdl-radio__label">Facebook Panel</span>
                            </label><br>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="lsb_fb">
    ...
    <script>
        ...
        $(document).on('change','#fmLSB input.mdl-radio__button',function(e){
            $.post("/circushandler.php",{Action:'setSetting',description:'LeftSidebar',text_value:$(this).val(),date_value:null,numeric_value:null});
        });
        $(document).on('change','#fmLSB input.mdl-textfield__input',function(e){
            $.post("/circushandler.php",{Action:'setSetting',description:'LeftFacebook',text_value:$(this).val(),date_value:null,numeric_value:null});
        });
        function getStarted(){
            $('html').addClass('wait');
            $.when(applySettings())
                ...
                $.post("/circushandler.php"
                    ...
                    , function (data) {
                        if(data>""){
                            ...
                            $.post("/circushandler.php"
                                , {Action: "getSidebar",location:'L'}
                                , function(data) {
                                    $('#dImages').html(data.cards);
                                    $("#fmLSB input[name=lsb][value=" + getFromArray(data.settings,'sidebar','#') + "]").prop('checked', true)
                                                                                                                        .parent().addClass('is-checked');
                                    if(getFromArray(data.settings,'facebook','') > "") {
                                        $('#fmLSB input.mdl-textfield__input').val(getFromArray(data.settings,'facebook',''))
